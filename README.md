...
5. Open your browser and go to page <http://chs.local/register-an-overseas-entity>
6. If you are using the api directly, then use this url: <http://chs.local/overseas-entities>
