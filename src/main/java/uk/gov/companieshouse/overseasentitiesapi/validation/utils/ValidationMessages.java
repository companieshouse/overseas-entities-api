...
public class ValidationMessages {
    ...
    public static final String TRUST_WITHOUT_BENEFICIAL_OWNERS_ERROR_MESSAGE = "The trust cannot remain involved in the overseas entity without at least one beneficial owner";
}
