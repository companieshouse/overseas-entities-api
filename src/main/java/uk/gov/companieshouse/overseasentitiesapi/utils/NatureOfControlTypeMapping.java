...
public class NatureOfControlTypeMapping {
  ...
  public static final Map<String, String> CHIPS_FORMAT_TO_PUBLIC_FORMAT = Map.ofEntries(
          ...
          Map.entry("OE_REGOWNER_AS_NOMINEEPERSON_ENGLANDWALES", "registered-owner-as-nominee-person-england-wales-registered-overseas-entity"),
          Map.entry("OE_REGOWNER_AS_NOMINEEPERSON_SCOTLAND", "registered-owner-as-nominee-person-scotland-registered-overseas-entity"),
          Map.entry("OE_REGOWNER_AS_NOMINEEPERSON_NORTHERNIRELAND", "registered-owner-as-nominee-person-northern-ireland-registered-overseas-entity"),

          Map.entry("OE_REGOWNER_AS_NOMINEEANOTHERENTITY_ENGLANDWALES", "registered-owner-as-nominee-another-entity-england-wales-registered-overseas-entity"),
          Map.entry("OE_REGOWNER_AS_NOMINEEANOTHERENTITY_SCOTLAND", "registered-owner-as-nominee-another-entity-scotland-registered-overseas-entity"),
          Map.entry("OE_REGOWNER_AS_NOMINEEANOTHERENTITY_NORTHERNIRELAND", "registered-owner-as-nominee-another-entity-northern-ireland-registered-overseas-entity"),
