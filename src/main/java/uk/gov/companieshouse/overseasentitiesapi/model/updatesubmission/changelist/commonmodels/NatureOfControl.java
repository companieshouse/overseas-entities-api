...
public class NatureOfControl {
  ...
  public void addNatureOfControlTypes(List<String> natureOfControlTypes) {
    if (this.natureOfControlTypes == null) {
      this.natureOfControlTypes = new ArrayList<>();
    }
    this.natureOfControlTypes.addAll(natureOfControlTypes);
  }
