...
public class ChangeOfCorrespondenceAddress extends Change {
    private final String CHANGE_NAME = "changeOfServiceAddress";

    @JsonProperty("address")
    private AddressDto address;

    public ChangeOfCorrespondenceAddress(AddressDto address){
