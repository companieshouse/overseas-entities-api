...
public class BeneficialOwnerChangeService {
     ...
     * owners, corporate entities, and others. This consolidated list provides a complete overview
     * of all beneficial ownership changes in the system.
     */
     ...
     *
     * @return A list of changes ({@code BeneficialOwnerChange<IndividualBeneficialOwnerPsc>}
     * objects) related to the beneficial owners of 'Individual' type. If no changes are detected,
     ...
     * related to the beneficial owners of 'Other' type. If no changes are detected, an empty list
     * is returned.
     */
     ...
     *
     * @return A list of changes ({@code BeneficialOwnerChange<CorporateBeneficialOwnerPsc>}
     * objects) related to the beneficial owners of 'Corporate' type. If no changes are detected, an
    ...
    /**
     * Converts a BeneficialOwnerGovernmentOrPublicAuthorityDto into a BeneficialOwnerChange
     * object.
     *
    ...
    private BeneficialOwnerChange<IndividualBeneficialOwnerPsc> covertBeneficialOwnerIndividualToChange(
        ...
        var delimiter = ",";
        var submissionNationalityArray = new String[]{beneficialOwnerIndividualDto.getNationality(),
                beneficialOwnerIndividualDto.getSecondNationality()};
        var submissionNationality = Arrays.stream(submissionNationalityArray)
                .filter(Objects::nonNull)
        ...
        if (beneficialOwnerIndividualDto.getFirstName() != null
                && beneficialOwnerIndividualDto.getLastName() != null) {
     ...
     * between the provided data in DTOs and the current state of these attributes in the PSC
     * object. If discrepancies are detected, the changes are applied accordingly.</p>
     *
     ...
     * @param residentialAddress The residential address DTO to be compared and potentially
     *                           applied.
